...
<div class="modals-container hidden">
    <div class="modal hidden" id="modal-team-1">
        <div class="modal-header">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/profile1.jpg" alt="profile" />
        </div>
    ...
    <div class="modal hidden" id="modal-team-2">
        <div class="modal-header">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/profile2.jpg" alt="profile" />
        </div>
        <div class="modal-body">
            <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing
    ...
    <div class="modal hidden" id="modal-team-3">
        <div class="modal-header">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/profile3.jpg" alt="profile" />
        </div>
        <div class="modal-body">
            <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing
    ...
    <div class="modal hidden" id="modal-team-4">
        <div class="modal-header">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/profile4.jpg" alt="profile" />
        </div>
        <div class="modal-body">
            <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing
    ...
    <div class="modal hidden" id="modal-team-5">
        <div class="modal-header">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/profile5.jpg" alt="profile" />
        </div>
        <div class="modal-body">
            <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing
    ...
    <div class="modal hidden" id="modal-team-6">
        <div class="modal-header">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/profile6.jpg" alt="profile" />
        </div>
        <div class="modal-body">
            <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing
...
<div class="main">
    ...
    <div class="about-history">
        <div class="about-history-img">
            <img
                src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/group-cert.jpg"
        ...
        <div class="about-team-wrapper">
            <div class="about-team-profile" id="team-1">
                <div class="about-team-profile-img">
                    <img
                        src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/profile1.jpg"
                        alt="A Person"
                        class="data-open"
                    />
                </div>
            ...
            <div class="about-team-profile" id="team-2">
                <div class="about-team-profile-img">
                    <img
                        src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/profile2.jpg"
                        alt="A Person"
                    />
                </div>
                <div class="about-team-profile-textarea">
            ...
            <div class="about-team-profile" id="team-3">
                <div class="about-team-profile-img">
                    <img
                        src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/profile3.jpg"
                        alt="A Person"
                    />
                </div>
                <div class="about-team-profile-textarea">
            ...
            <div class="about-team-profile">
                <div class="about-team-profile-img">
                    <img
                        src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/profile4.jpg"
                        alt="A Person"
                    />
                </div>
                <div class="about-team-profile-textarea">
            ...
            <div class="about-team-profile">
                <div class="about-team-profile-img">
                    <img
                        src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/profile5.jpg"
                        alt="A Person"
                    />
                </div>
                <div class="about-team-profile-textarea">
            ...
            <div class="about-team-profile">
                <div class="about-team-profile-img">
                    <img
                        src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/profile6.jpg"
                        alt="A Person"
                    />
                </div>
                <div class="about-team-profile-textarea">
    ...
    <div class="photos-single-column">
        <div class="single-photo">
            <a
                href="<?php echo get_stylesheet_directory_uri(); ?>/img/about/photo1.jpg"
                data-lightbox="about-lightbox-strip-1"
                ><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/photo1.jpg" alt=""
            /></a>
        </div>
        <div class="single-photo">
            <a
                href="<?php echo get_stylesheet_directory_uri(); ?>/img/about/photo2.jpg"
                data-lightbox="about-lightbox-strip-1"
                ><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/photo2.jpg" alt=""
            /></a>
        </div>
        <a class="anchor" id="anchor-ecosystem"></a>
        <div class="single-photo">
            <a
                href="<?php echo get_stylesheet_directory_uri(); ?>/img/about/photo3.jpg"
                data-lightbox="about-lightbox-strip-1"
                ><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/photo3.jpg" alt=""
            /></a>
        </div>
    </div>
    <div class="about-section-header">
    ...
    <div class="about-partners">
        <div class="about-partner-logo">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/company1.png" alt="" />
        </div>
        <div class="about-partner-logo">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/company2.png" alt="" />
        </div>
        <div class="about-partner-logo">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/company3.png" alt="" />
        </div>
        <div class="about-partner-logo">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/company4.png" alt="" />
        </div>
        <div class="about-partner-logo">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about/company4.png" alt="" />
        </div>
