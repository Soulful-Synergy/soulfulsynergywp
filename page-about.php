...
<div class="modals-container hidden">
    <?php
    // Initialize Query to Get Team Members
    $args = array(
    ...
    if( $the_query->have_posts() ) {
        ...
        while( $the_query->have_posts() ) {
            ...
            ?> 
            <div class="modal hidden" id="modal-team-<?php echo $i; ?>">
                <div class="modal-header">
                    <img src="<?php echo get_field("tm_image")["url"]; ?>">
                </div>
                <div class="modal-body">
                    <?php echo get_field("tm_bio"); ?>
...
<div class="main" id="anchor-top">
    ...
    <div class="about-history">
        ...
        <div class="about-history-textarea">
            <div class="about-history-textarea-leftcol">
                <?php echo get_theme_mod('our_history_left'); ?>
            </div>
            <div class="about-history-textarea-rightcol">
                <?php echo get_theme_mod('our_history_right'); ?>
            </div>
        </div>
    </div>
    <div id="award-strip-1" class="about-award-strip">
        ...
        <div class="about-award-col">
            ...
            <?php echo get_theme_mod("award_1_row2_col3"); ?>
            </div>
        </div>
    </div>
    ...
    <div class="about-team">
        ...
        if( $the_query->have_posts() ) {
            ...
            while( $the_query->have_posts() ) {
                ...
                <div class="about-team-profile" id="team-".$it>
                    <div class="about-team-profile-img">
                        <img src="<?php echo get_field("tm_image")["url"];?>" alt="Profile Picture" class="data-open">
                    </div>    
                    <div class="about-team-profile-textarea">
                        ...
                        <div class="about-team-profile-textarea-title">
                            <span><?php echo get_field("tm_title"); ?></span>
                        </div>
                    </div>
                </div>
                <?php
    ...
    <div id="award-strip-2" class="about-award-strip">
        <div class="about-award-col">
            <div class="about-award-row"><?php echo get_theme_mod("award_2_row1_col1"); ?></div>
            <div class="about-award-row"><?php echo get_theme_mod("award_2_row2_col1"); ?></div>
        </div>
        <div class="about-award-col">
            <div class="about-award-row"><?php echo get_theme_mod("award_2_row1_col2"); ?></div>
            <div class="about-award-row"><?php echo get_theme_mod("award_2_row2_col2"); ?></div>
        </div>
        <div class="about-award-col">
            <div class="about-award-row"><?php echo get_theme_mod("award_2_row1_col3"); ?></div>
            <div class="about-award-row">
            <?php echo get_theme_mod("award_2_row2_col3"); ?>
            </div>
        </div>
    </div>
    ...
    <div id="award-strip-3" class="about-award-strip">
        <div class="about-award-col">
            <div class="about-award-row"><?php echo get_theme_mod("award_3_row1_col1"); ?></div>
            <div class="about-award-row"><?php echo get_theme_mod("award_3_row2_col1"); ?></div>
        </div>
        <div class="about-award-col">
        ...
        <div class="about-award-col">
            ...
            <div class="about-award-row">
            <?php echo get_theme_mod("award_3_row2_col3"); ?>
            </div>
        </div>
    </div>
    </div>
            ...
            if( $the_query->have_posts() ) {
                while( $the_query->have_posts() ) {
                    ...
                    <div class="about-partner-logo">
                        <a href="<?php echo get_field("partner_link"); ?>" target="_blank"><img src="<?php echo get_field("partner_image")["url"]; ?>" alt="Partner Logo"></a>
                    </div>
                    <?php
                }
            }else{
    ...
    <div id="award-strip-4" class="about-award-strip">
        <div class="about-award-col">
            <div class="about-award-row"><?php echo get_theme_mod("award_4_row1_col1"); ?></div>
            <div class="about-award-row"><?php echo get_theme_mod("award_4_row2_col1"); ?></div>
        </div>
        <div class="about-award-col">
        ...
        <div class="about-award-col">
            ...
            <div class="about-award-row">
            <?php echo get_theme_mod("award_4_row2_col3"); ?>
            </div>
        </div>
    </div>
    </div>
